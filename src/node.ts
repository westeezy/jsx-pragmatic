...
export type NodeType = ElementNode | TextNode | FragmentNode | ComponentNode<any>; // eslint-disable-line no-use-before-define

export type ChildNodeType = ElementNode | TextNode | ComponentNode<any>; // eslint-disable-line no-use-before-define
...
) => ElementNode; // eslint-disable-line no-use-before-define

export type CreateComponentNode = <P>(
    arg0: ComponentFunctionType<P>,
    arg1: P,
    ...rest: NullableChildrenType
) => ComponentNode<any>; // eslint-disable-line no-use-before-define
...
function renderChildren<T>(children: ReadonlyArray<ElementNode | TextNode | ComponentNode<any>>, renderer: NodeRenderer<any, any>): ReadonlyArray<T> { // eslint-disable-line no-use-before-define
    const result = [];
...
export class ElementNode {
    ...
    name: string;
    props: NodePropsType;
    children: ReadonlyArray<ElementNode | TextNode | ComponentNode<any>>; // eslint-disable-line no-use-before-define
...
export class FragmentNode {
    ...
    constructor(children: ReadonlyArray<ElementNode | TextNode | ComponentNode<any>>) { // eslint-disable-line no-use-before-define
        this.children = children;
    }
